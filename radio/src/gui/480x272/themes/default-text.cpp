...
class DefaultTextTheme: public Theme
{
  public:
    DefaultTextTheme():
      Theme("Default-Text", OPTIONS_THEME_DEFAULT)
    {
    }
...
const BitmapBuffer * DefaultTextTheme::backgroundBitmap = NULL;
BitmapBuffer * DefaultTextTheme::topleftBitmap = NULL;
BitmapBuffer * DefaultTextTheme::menuIconNormal[MENUS_ICONS_COUNT] = { NULL };
BitmapBuffer * DefaultTextTheme::menuIconSelected[MENUS_ICONS_COUNT] = { NULL };
BitmapBuffer * DefaultTextTheme::currentMenuBackground = NULL;

DefaultTextTheme defaultTextTheme;
//Theme * theme = &defaultTextTheme;
